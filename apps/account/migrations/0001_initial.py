    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nickname', models.CharField(blank=True, default='', max_length=50, null=True, verbose_name='nickname')),
                ('gender', models.CharField(choices=[('F', 'Female'), ('M', 'Male'), ('N', 'None')], default='N', max_length=10, verbose_name='gender')),
                ('avatar', models.CharField(default='', max_length=500, verbose_name='head_portrait')),
